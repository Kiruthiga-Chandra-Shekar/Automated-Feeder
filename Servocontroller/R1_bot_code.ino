  /*******LX-15D Serial Servo Testing Program 2*******
...
int digitalState = digitalRead(13);
if(digitalState == LOW)
{

//2
  Serial.print("Going for Pick up!");

  LobotSerialServoMove(Serial, ID1, 520, 1000);
  LobotSerialServoMove(Serial, ID2, 498, 1000);
  LobotSerialServoMove(Serial, ID3, 499, 1000);
  LobotSerialServoMove(Serial, ID4, 497, 1000);
  LobotSerialServoMove(Serial, ID5, 498, 1000);
...
//3
  LobotSerialServoMove(Serial, ID1, 520, 1000);
  LobotSerialServoMove(Serial, ID2, 498, 1000);
  LobotSerialServoMove(Serial, ID3, 805, 1000);
  LobotSerialServoMove(Serial, ID4, 335, 1000);
  LobotSerialServoMove(Serial, ID5, 513, 1000);
  LobotSerialServoMove(Serial, ID6, 868, 1000);
  delay(1000);


//4
  LobotSerialServoMove(Serial, ID1, 0, 1000);
  LobotSerialServoMove(Serial, ID2, 128, 1000);
  LobotSerialServoMove(Serial, ID3, 703, 1000);
  LobotSerialServoMove(Serial, ID4, 218, 1000);
  LobotSerialServoMove(Serial, ID5, 395, 1000);
  LobotSerialServoMove(Serial, ID6, 869, 1000);
  delay(1000);
